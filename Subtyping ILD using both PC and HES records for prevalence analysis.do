...
*
 ...
 preserve 
 use "DA3_ILD_cohort_flagged_173428_NEWprev.dta", clear
...
*/
 ...
 tab subtype,m
 drop _m
 save DA4_hp_cohort_32768_NEWprev.dta, replace
...
*/
 ...
 tab subtype,m
 drop _m
 save DA4_ipf_cohort_120823_NEWprev.dta, replace
...
*/
 ...
 tab subtype,m
 drop _m
 save "DA4_ctdild_cohort_27740prev.dta", replace
...
*/
 ...
 tab subtype,m
 drop _m
 save "DA4_drugrad_cohort_27740prev.dta", replace
...
*/
 ...
 tab subtype,m
 drop _m
 save "DA4_psarc_cohort_27740prev.dta", replace
...
*/
 gen subtype=6
 tab subtype,m
 save "DA4_otherild_cohort_27740prev.dta", replace
 *************************************************************
...
*/
 ...
 tab subtype,m
 drop _m
 save "DA4_broad_cohort_27740prev.dta", replace
 ************************************************************************ 
   use "${path_deriv_dta}ILD_cohort_flagged_76772.dta" , clear
...
*/
 ...
 tab subtype,m
 drop _m
 save "DA4_contradictory_cohort_27740prev.dta", replace
  
 
clear
use "DA4_contradictory_cohort_27740prev.dta"
 ** append
 append using "DA4_hp_cohort_32768_NEWprev"
 append using "DA4_ipf_cohort_120823_NEWprev"
 append using "DA4_ctdild_cohort_27740prev.dta"
 append using "DA4_drugrad_cohort_27740prev.dta"
 append using "DA4_psarc_cohort_27740prev.dta"
 append using "DA4_otherild_cohort_27740prev.dta"
 append using "DA4_broad_cohort_27740prev.dta"
 ...
 ** 
 save "DA4_allILD_cohort_newprev.dta", replace
  
  use "DA4_allILD_cohort_newprev.dta", clear
 codebook patid
...
------------+-----------------------------------
      Total |     21,438      100.00
  */
** so reasign conflicts using same rules 
 ...
 ** 
 save "${path_intermediate_dta}DA4_ILD_cohort_allobs_NEWprev.dta", replace
 
 
 use "${path_intermediate_dta}DA4_ILD_cohort_allobs_NEWprev.dta", clear
...
drop if earliest_mention==.  // justt one
  save "DA4_ILD_cohort_171106_NEWprev", replace
...
use "DA4_ILD_cohort_171106_NEWprev", clear  
...
save "DA4_ILD_cohort_flagged_196905_NEWprev.dta", replace

codebook patid

 
 ** 20 august recode  and add additional categoty
 
 use "X:\Ann\BI_ILD_projects\non_IPF_ILDs_epi\analysis\cohort_prep\deriv_dta/DA4_ILD_cohort_flagged_196905_NEWprev.dta", clear
 codebook patid // 
...
keep if litn==1
drop litn bign
save "X:\Ann\BI_ILD_projects\non_IPF_ILDs_epi\analysis\cohort_prep\deriv_dta/DA4_ILD_cohort_flagged_196905_NEWprev.dta", replace
 ***************  END *************************