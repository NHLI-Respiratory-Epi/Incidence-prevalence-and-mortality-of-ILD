...
save "hes_apc_ild_episodes_NEW.dta", replace 

use "hes_apc_ild_episodes_NEW.dta", replace 
 
* Step 2::

  
  use "hes_apc_ild_episodes_NEW.dta", clear // spelled version
...
** reduce to one line per spell
  sort patid spell admidatenum_obs
  by patid spell: gen obs =_n
  by patid spell: gen num_obs=_N
...
compress
save "hes_apc_ild_spells_all_NEW.dta", replace
 
 tab hes_subtype, m
 

use hes_apc_ild_spells_all_NEW.dta, clear
 ...
 * copy ealiest admidate to all row for that patient
 ...
 save DA3_hes_apc_only_subtyped_byfullspellhistory_NEW.dta, replace
...
compress
save DA3_hes_apc_only_subtyped_bypatientall_NEW.dta, replace
restore

codebook patid // sa 217,846 //b218,091 (232,090) people have admissions with an ild code somewhere

use DA3_hes_apc_only_subtyped_bypatientall_NEW.dta, clear
